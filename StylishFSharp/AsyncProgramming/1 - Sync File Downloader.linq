...
module Outcome = 
    ...
    //function allows to pattern match from a DU instance to a case without
    //providing an explicit DU instance
    let isOk = function 
        | OK _ -> true 
        | Failed _ -> false
...
module Download =
    ...
    let GetFiles 
        ...
        let downloaded, failed = 
            ...
            |> Array.partition Outcome.isOk //useful partitionaing an array into a tuple of arrays based on a predicate
